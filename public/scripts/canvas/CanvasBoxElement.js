...
CanvasBoxElement = (function() {
  ...
  CanvasBoxElement.prototype.getConnectors = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      objElement = _ref[_i];
      if (php.is_object(objElement) && (objElement.objElementFrom === this || objElement.objElementTo === this) && objElement !== this) {
...
//# sourceMappingURL=maps/CanvasBoxElement.js.map