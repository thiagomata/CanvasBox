...
CanvasBox = (function() {
  ...
  /*
      ...
      # @type integer
      */
  CanvasBox.prototype.boxWidth = 400;
  /*
      # Height of the Sand Box
      # @type integer
      */
  CanvasBox.prototype.boxHeight = 400;
  /*
  ...
  /*
      ...
      # @return CanvasBox
      */
  CanvasBox.prototype.initialize = function(idCanvasHtmlElement, intWidth, intHeight) {
    var objButton;
    ...
    this.objCanvasHtml.bind('onmousemove', __bind(function(event) {
      return this.onMouseMove(event);
    }, this));
    this.objCanvasHtml.bind('onclick', __bind(function(event) {
      return this.onClick(event);
    }, this));
    this.objCanvasHtml.bind('ondblclick', __bind(function(event) {
      return this.onClick(event);
    }, this));
    this.objCanvasHtml.bind('onmouseup', __bind(function(event) {
      return this.onClick(event);
    }, this));
    this.objCanvasHtml.bind('onmousedown', __bind(function(event) {
      return this.onMouseDown(event);
    }, this));
    this.objCanvasHtml.bind('oncontextmenu', __bind(function(event) {
      return this.onConContextMenu(event);
    }, this));
    this.objCanvasHtml.bind('onKeyup', __bind(function(event) {
      return this.onKeyup(event);
    }, this));
    this.objCanvasHtml.bind('onMouseOut', __bind(function(event) {
      return this.onMouseOut(event);
    }, this));
    this.objCanvasHtml.bind('onMouseOver', __bind(function(event) {
  ...
  CanvasBox.prototype.setStrokeStyle = function(intStrokeStyle) {
