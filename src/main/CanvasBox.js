...
CanvasBox = (function() {
  ...
  CanvasBox.prototype.initialize = function(idCanvasHtmlElement, intWidth, intHeight) {
    ...
    this.objCanvasHtml.onmousemove = __bind(function(event) {
      return this.onMouseMove(event);
    }, this);
    this.objCanvasHtml.onclick = __bind(function(event) {
      return this.onClick(event);
    }, this);
    this.objCanvasHtml.ondblclick = __bind(function(event) {
      return this.onClick(event);
    }, this);
    this.objCanvasHtml.onmouseup = __bind(function(event) {
      return this.onClick(event);
    }, this);
    this.objCanvasHtml.onmousedown = __bind(function(event) {
      return this.onMouseDown(event);
    }, this);
    this.objCanvasHtml.oncontextmenu = __bind(function(event) {
      return this.onConContextMenu(event);
    }, this);
    this.objCanvasHtml.onKeyup = __bind(function(event) {
      return this.onKeyup(event);
    }, this);
    this.objCanvasHtml.onMouseOut = __bind(function(event) {
      return this.onMouseOut(event);
    }, this);
    this.objCanvasHtml.onMouseOver = __bind(function(event) {
