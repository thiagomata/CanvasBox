...
CanvasBox = (function() {
  ...
  */
  ...
  function CanvasBox(idCanvasHtmlElement, intWidth, intHeight) {
    ...
    this.objCanvasHtml.addEventListener('mousemove', function(event) {
      return _this.onMouseMove(event);
    });
    this.objCanvasHtml.addEventListener('click', function(event) {
      return _this.onClick(event);
    });
    this.objCanvasHtml.addEventListener('dblclick', function(event) {
      return _this.onDblClick(event);
    });
    this.objCanvasHtml.addEventListener('mouseup', function(event) {
      return _this.onMouseUp(event);
    });
    this.objCanvasHtml.addEventListener('mousedown', function(event) {
      return _this.onMouseDown(event);
    });
    this.objCanvasHtml.addEventListener('contextmenu', function(event) {
      return _this.onContextMenu(event);
    });
    this.objCanvasHtml.addEventListener('keyup', function(event) {
      return _this.onKeyUp(event);
    });
    this.objCanvasHtml.addEventListener('mouseout', function(event) {
      return _this.onMouseOut(event);
    });
    this.objCanvasHtml.addEventListener('mouseover', function(event) {
  ...
  */
  ...
  CanvasBox.prototype.setFont = function(strFontDescription) {
    var arrFontData, dblSizeNumber, key, strFontData, strNewSizeNumber, strSizeNumber, strSizeType, _i, _len;
    try {
