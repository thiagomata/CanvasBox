...
###
File created automatically based on the php_js.js project, version 1.3.2
@author Kevin van Zonneveld <kevin@vanzonneveld.net>
@link http://phpjs.org
###
php_js = {}
php_js.require = require = (filename) ->
  ...
  0
php_js.require_once = require = (filename) ->
...
php_js.file_get_contents = file_get_contents = (url, flags, context, offset, maxLen) ->
  ...
  if not context or not context.stream_options or http_stream
    ...
    if tmp
      ...
      # see http://php_js.net/manual/en/reserved.variables.httpresponseheader.php
...
php_js.file_exists = file_exists = (url) ->
...
php_js.implode = implode = (glue, pieces) ->
...
php_js.explode = explode = (delimiter, string, limit) ->
...
php_js.array_keys = array_keys = (input, search_value, argStrict) ->
...
php_js.in_array = in_array = (needle, haystack, argStrict) ->
...
php_js.sort = sort = (inputArr, sort_flags) ->
...
php_js.method_exists = method_exists = (obj, method) ->
...
php_js.is_object = is_object = (mixed_var) ->
